...
export const PLANS = [
  {
    ...
    features: [
      ...
      "Bilan simplifié (actifs, passifs, patrimoine net)",
      "Data Room : stockage sécurisé de vos documents",
    ],
  },
  {
    id: "premium",
    ...
    features: [
      ...
      "Analyse financière avancée : compte de résultat, cash-flow, DSCR",
      "Score de santé financière et dossier de financement PDF",
